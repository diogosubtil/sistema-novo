<x-layout>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-12">
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input id="name" name="name" type="text" class="form-control"
                                                               value="{{ $setting->name }}" placeholder="Nome">
                                                    </div>
                                                    <span class="form-bar">
                                                        @if ($errors->get('name'))
                                                ...
                                                <div class="col-xl-12 col-md-6 col-12">
                                                    <label for="color_primary" class="col-form-label">Cor
                                                        Primaria</label>
                                                    <input type="text" id="hue-demo" name="color_primary"
                                                           class="form-control demo" data-control="hue"
                                                           value="{{ $setting->color_primary }}">
                                                    <span class="form-bar">
                                                ...
                                                <div class="col-xl-12 col-md-6 col-12">
                                                    <label for="color_secondary" class="col-form-label">Cor
                                                        Secundario</label>
                                                    <input type="text" id="hue-demo" name="color_secondary"
                                                           class="form-control demo" data-control="hue"
                                                           value="{{ $setting->color_secondary }}">
                                                    <span class="form-bar">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            ...
                                            <div
                                                class="input-group input-group-button d-flex justify-content-center align-content-center">
                                                <div class="side-menu-user-info">
                                                    <div class="side-menu-user-photo">
                                                        <img id="imgLogo" src="{{ asset($setting->logo) }}"
                                                             alt="your image"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="fileUpload btn btn-primary">
                                                <span>Upload</span>
                                                <input type="file" name="logo" id="logo" value="teste"
                                                       onchange="loadFileLogo(event)" class="upload"/>
                                            </div>
                                            <span class="form-bar">
                                                @if ($errors->get('logo'))
                                                    <ul class="text-danger">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            ...
                                            <div
                                                ...
                                                <div class="side-menu-user-info">
                                                    <div class="side-menu-user-photo">
                                                        <img id="imgFavicon" src="{{ asset($setting->favicon) }}"
                                                             alt="your image"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="fileUpload btn btn-primary">
                                                <span>Upload</span>
                                                <input type="file" name="favicon" id="favicon" value="teste"
                                                       onchange="loadFileFavicon(event)" class="upload"/>
                                            </div>
                                            <span class="form-bar">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            ...
                                            <input type="text" id="hue-demo" name="color_menu" class="form-control demo"
                                                   data-control="hue" value="{{ $setting->color_menu }}">
                                            <span class="form-bar">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            ...
                                            <input type="text" id="hue-demo" name="color_menu_letter"
                                                   class="form-control demo" data-control="hue"
                                                   value="{{ $setting->color_menu_letter }}">
                                            <span class="form-bar">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            <label for="color_menu_letter_active" class="col-form-label">Cor das Letras
                                                (Ativas)</label>
                                            <input type="text" id="hue-demo" name="color_menu_letter_active"
                                                   class="form-control demo" data-control="hue"
                                                   value="{{ $setting->color_menu_letter_active }}">
                                            <span class="form-bar">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            ...
                                            <input type="text" id="hue-demo" name="color_menu_icon"
                                                   class="form-control demo" data-control="hue"
                                                   value="{{ $setting->color_menu_icon }}">
                                            <span class="form-bar">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            <label for="color_login" class="col-form-label">Cor de fundo</label>
                                            <input type="text" id="hue-demo" name="color_login" class="form-control demo"
                                                   data-control="hue" value="{{ $setting->color_login }}">
                                            <span class="form-bar">
                                                @if ($errors->get('color_login'))
                                                    <ul class="text-danger">
                                                        @foreach ((array) $errors->get('color_login') as $message)
                                                            <li>{{ $message }}</li>
                                                        @endforeach
                                                    </ul>
                                                @endif
                                ...
                                <div class="col-12">
                                    <button id="cadastrar" type="submit"
                                            class="text-sm pl-4 pr-4 btn bg-primary b-radius-5">Salvar
                                    </button>
                                    <a href="{{ route('settings.edit', 1) }}">
                                        <button type="button" class="text-sm pl-4 pr-4 ml-2 btn bg-round b-radius-5">
                                            Cancelar
                                        </button>
                                    </a>
                                </div>
    ...
    @slot('scripts')
        <script type="text/javascript"
                src="{{ asset('/files/bower_components/jquery-minicolors/js/jquery.minicolors.min.js') }}"></script>
        <script type="text/javascript"
                src="{{ asset('/files/assets/pages/advance-elements/custom-picker.js') }}"></script>
