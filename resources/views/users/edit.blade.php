    ...
    @slot('slot')
        <div class="row">
            <div class="col-12">
                <div class="p-2 card">
                    <div class="col-12">
                        <form method="POST" data-loading="true" action="{{ route('users.update', $user->id) }}">
                            @csrf
                            @method('PUT')
                            <!-- Name -->
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6 col-12 mt-3">
                                            ...
                                            <span class="input-group-addon bg-primary" id="basic-addon1">
                                                ...
                                                <input id="name" name="name" type="text" class="form-control" value="{{ $user->name }}" placeholder="Nome">
                                            </div>
                                            <span class="form-bar">
                                            @if ($errors->get('name'))
                                        ...
                                        <div class="col-xl-3 col-md-6 col-12 mt-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="telefone" class="form-control telphone_with_code" data-mask="(99) 99999-9999" telphon type="text" name="telefone" value="{{ $user->telefone }}" placeholder="Telefone">
                                            </div>
                                            <span class="form-bar">
