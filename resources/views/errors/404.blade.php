...
<html lang="en-us" class="no-js">
	...
	<head>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" href="{{ asset('/files/extra-pages/404/1/img/favicon.ico') }}">
	...
	<body class="flat">
        ...
        <a href="#" class="logo-link" title="back home">
            ...
            <img src="{{ asset('/files/extra-pages/404/1/img/logo.png') }}" class="logo" alt="Company's logo">
        ...
        <div class="content">
            ...
            <div class="content-box">
                ...
                <p>A página que você procura não existe.<br>
                    Achamos que a página pode ter sido removida.</p>
    ...
    <footer class="light">
        ...
        <!-- Particles plugin -->
        <script src="{{ asset('/files/extra-pages/404/1/js/particles.js') }}"></script>
