    ...
    @slot('slot')
        <div class="row">
            <div class="col-lg-12 col-12">
                <div class="p-2 card">
                    <div class="col-12">
                        <form method="POST" data-loading="true" action="{{ route('unidades.store') }}">
                            @csrf
                            <!-- Name -->
                            <div class="row">
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6 mt-3">
                                            ...
                                            <span class="input-group-addon bg-primary" id="basic-addon1">
                                                ...
                                                <input id="meta" name="meta" type="number" class="form-control" value="{{ old('meta') }}" min="0" placeholder="Meta">
                                            </div>
                                            <span class="form-bar">
                                            @if ($errors->get('meta'))
                                                    <ul class="text-danger">
