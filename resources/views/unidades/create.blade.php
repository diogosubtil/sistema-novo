                    ...
                    <div class="col-12">
                        <form method="POST" action="{{ route('unidades.store') }}">
                                ...
                                <div class="row col-12 p-4">
                                    ...
                                    <div class="col-lg-2 col-12 mt-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="cnpj" name="cnpj" type="text" class="form-control" value="{{ old('cnpj') }}" placeholder="CNPJ">
                                        </div>
                                        <span class="form-bar">
                                            @if ($errors->get('cnpj'))
                                    ...
                                    <div class="col-lg-2 col-12 mt-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="whatsapp" class="form-control telphone_with_code" data-mask="(99) 99999-9999" telphon type="text" name="whatsapp" value="{{ old('whatsapp') }}" placeholder="Whatsapp">
                                        </div>
                                        <span class="form-bar">
                                ...
                                <div class="row col-lg-3 col-12 p-4 mt-2 mr-1">
                                    ...
                                    <div class="col-lg-12 col-12 mt-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="cep" name="cep" onblur="pesquisacep(this.value)" type="text" class="form-control" value="{{ old('cep') }}" placeholder="CEP">
                                        </div>
                                        <span class="form-bar">
                                            @if ($errors->get('cep'))
                                                <ul class="text-danger">
                                    ...
                                    <div class="col-12">
                                        <div class="input-group">
                                            <label for="cidade"><b>Cidade:</b> </label><span class="ml-2" id="cidadeText">{{ old('cidade') }}</span>
                            ...
                            <div class="flex items-center justify-end mt-4">
                                <button id="cadastrar"  type="submit" class="text-sm pl-4 pr-4 btn bg-primary b-radius-5">Cadastrar</button>
                            </div>
                        </form>
                    </div>
                </div>
