                        ...
                        <form method="POST" action="{{ route('unidades.update', $unidade->id) }}">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-9 col-12 mt-3">
                                            ...
                                            <span class="input-group-addon bg-primary" id="basic-addon1">
                                                ...
                                                <input id="cep" name="cep" onblur="pesquisacep(this.value)" type="text" class="cep form-control" value="{{ $unidade->cep }}" placeholder="CEP">
                                            </div>
                                            <span class="form-bar">
                                            @if ($errors->get('cep'))
                                                    <ul class="text-danger">
                                        ...
                                        <div class="col-12">
                                            <div class="input-group">
                                                ...
                                                <span class="ml-2" id="cidadeText">{{ $unidade->cidade }}</span>
                                        ...
                                        <div class="col-xl-9 col-12">
                                            ...
                                            <span class="input-group-addon bg-primary" id="basic-addon1">
                                                ...
                                                <input id="numero" name="numero" type="number" class="form-control" value="{{ $unidade->numero }}" placeholder="Numero">
                                            </div>
                                            <span class="form-bar">
                                ...
                                <div id="userUnidade" style="" class="col-xl-8 col-12 mt-2">
                                    ...
                                    <div hidden id="campoAssinar" class="col-12 mt-4">
                                        <div class="row">
